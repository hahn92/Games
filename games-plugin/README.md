...
Plugin para el proyecto de juegos de navegador. Provee skills, agentes y hooks automáticos para crear, validar y mantener los 20 juegos clásicos.
...
| `/games:audit-sounds` | Revisa cobertura de sonido en los 20 juegos y lista qué falta |
