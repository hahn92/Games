---
name: sound-auditor
description: Audits GameAudio sound coverage across all 54 games. Shows which games have audio.js, which sounds are present, and what is missing. Use after adding sounds to verify full coverage.
---
